...
<head>
	...
	<title>100多个纯CSS3动画图标DEMO演示</title>
	<%@ include file="../commons/common.jsp"%>
	<link rel='stylesheet prefetch' href='../styles/icon/icono.min.css'>
	<link rel="stylesheet" href="../styles/icon/style.css" type="text/css" />
</head>
...
<body>
	...
	<br><br>
	<div class="stage">
		<span><i class="icono-home"></i></span>
		...
		<span><i class="icono-sync spin"></i></span> 
		<span><i class="icono-reset"></i></span> 
		<span><i class="icono-reset spin"></i></span>
		<span><i class="icono-gear"></i></span> 
		<span><i class="icono-gear spin"></i></span> 
		...
		<span><i class="icono-pieChart"></span></i>
