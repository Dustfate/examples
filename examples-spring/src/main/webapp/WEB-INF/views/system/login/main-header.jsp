			...
			<ul class="nav navbar-nav">
							...
							<ul class="menu">
								<li>
									<!-- start message --> <a href="#">
										<div class="pull-left">
											<!-- User Image -->
											<img src="${ctx }/AdminLTE-2.3.3/dist/img/user2-160x160.jpg"
				...
				<li class="dropdown user user-menu">
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
						...
						<img src="${ctx }/AdminLTE-2.3.3/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header">
							<img src="${ctx }/AdminLTE-2.3.3/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
							<p>
