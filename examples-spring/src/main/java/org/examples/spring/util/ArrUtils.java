...
public class ArrUtils {
	 ...
	 * <code>ArrUtils.clone(new int[] {2})</code>.
	 * </p>
	 * <p/>
	 * <p>
	 ...
	 *
	 * @param array
	 *            an array whose elements are either a {@link Map.Entry} or an
	 *            Array containing at least two elements, may be
	 *            <code>null</code>
	 ...
	 * @throws IllegalArgumentException
	 *             if the array contains elements other than {@link Map.Entry}
	 *             and an Array
	 */
