package org.examples.spring.util.office;
...
/**
 * @author liyd
 * @version $Id: DefaultExcelStyleCreate.java, v 0.1 2013-1-17 上午10:43:20 liyd
 *          Exp $
 */
public class DefaultExcelStyleCreator implements ExcelStyleCreator {
	 ...
	 *            列的值
	 */
	public void createPictureCellStyle(HSSFWorkbook workbook, HSSFSheet sheet, HSSFRow row, int rowIndex, int cellIndex,
			byte[] value) {
