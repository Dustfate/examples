package org.examples.spring.dao.jdbc;
...
import org.examples.spring.util.MyBeanUtils;
...
public class JdbcDao extends SimpleJdbcTemplate {
	 ...
	 * @return bean对象集合
	 */
	public List<Object> find(String sql, Class<Object> clazz, Map<Object, Object> parameters) {
	 ...
	 * @return bean对象
	 */
	public Object findForObject(String sql, Class<Object> clazz, Map<Object, Object> parameters) {
	 ...
	 * @return bean对象
	 */
	public long findForLong(String sql, Map<String, ?> parameters) {
	 ...
	 * @return bean对象
	 */
	public Map<String, Object> findForMap(String sql, Map<Object, Object> parameters) {
	 ...
	 * @return bean对象
	 */
	public List<Map<String, Object>> findForListMap(String sql, Map<String, Object> parameters) {
	 ...
	 * @param parameters
	 */
	public int executeForMap(String sql, Map<String, Object> parameters) {
	...
	public static String jeecgCreatePageSql(String sql, int page, int rows) {
		...
		// }else
		// if(ResourceUtil.getJdbcUrl().indexOf(DATABSE_TYPE_POSTGRE)!=-1){
		...
		// } else
		// if(ResourceUtil.getJdbcUrl().indexOf(DATABSE_TYPE_SQLSERVER)!=-1) {
